...
AI was used to scaffold `make_dataset.py`, `train.py` and `log_partner_note.py` for boilerplate to log the commands by my partner, and to discuss the repository layout. Claude was also used to find the exact places it had helped me with debugging, as mentioned below:
